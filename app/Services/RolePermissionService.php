...
class RolePermissionService
{
    ...
    public static function catalogForRole(string $slug): array
    {
        return match ($slug) {
            'admin', 'admin-sadu' => [
                'Projects' => ['view', 'approve', 'rate'],
                'Ledger' => ['view', 'approve'],
                'Proof Documents' => ['view', 'approve'],
                'Meetings' => ['view', 'approve minutes'],
                'Ratings' => ['view', 'moderate'],
                'Notifications' => ['view', 'send'],
            ],
            'csg' => [
                'Projects' => ['view', 'create', 'edit', 'delete'],
                'Ledger' => ['view', 'create', 'edit', 'delete', 'submit'],
                'Proof Documents' => ['view', 'upload', 'delete'],
                'Meetings' => ['view', 'create', 'edit', 'delete', 'upload minutes'],
                'Ratings' => ['view'],
                'Notifications' => ['view'],
            ],
            'student', 'teacher' => [
    ...
    public static function defaultGrants(): array
    {
        return [
            'superadmin' => ['*'],
            'admin' => [
                'projects.view', 'projects.approve', 'projects.rate',
                'ledger.view', 'ledger.approve',
                'proof-documents.view', 'proof-documents.approve',
                'meetings.view', 'meetings.approve-minutes',
                'ratings.view', 'ratings.moderate',
            ...
            'csg' => [
                ...
                'ledger.view', 'ledger.create', 'ledger.edit', 'ledger.submit',
                'proof-documents.view', 'proof-documents.upload', 'proof-documents.delete',
                'meetings.view', 'meetings.create', 'meetings.edit', 'meetings.upload-minutes',
                'ratings.view',
                'notifications.view',
            ],
            'student' => [
