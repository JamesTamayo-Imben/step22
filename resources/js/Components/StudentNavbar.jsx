...
export function StudentNavbar({ currentView, onNavigate, onLogout, onSwitchRole, userData }) {
  ...
  return (
    <>
      ...
      >
        ...
        {/* Navigation */}
        <nav className="flex-1 p-4 overflow-y-auto h-[calc(100vh-250px)]">
        ...
        <div className="p-4 border-t border-gray-200 space-y-2">
          ...
          {onSwitchRole && userData?.canSwitch && (
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-orange-500 to-pink-500 text-white hover:from-orange-600 hover:to-pink-600 rounded-xl transition-all shadow-md mb-2"
            >
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 hover:bg-gray-50 rounded-xl transition-all"
          >
            <div className="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center text-white text-xs">
              ST
            </div>
            <div className="flex-1 text-left">
              <p className="text-sm text-gray-900">Student Name</p>
              <p className="text-xs text-blue-600">500 points</p>
            </div>
          </button>
          <button
            onClick={() => {
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-40 px-4 py-3">
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg shadow-md"
          >
