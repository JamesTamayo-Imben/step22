...
function AddLedgerModal({ open, onClose, ledgerForm, setLedgerForm, onSave, projectId, projectBudgetBreakdown = [] }) {
...
function EditLedgerModal({ open, onClose, ledgerForm, setLedgerForm, onSave }) {
